...
# test
CUDA_VISIBLE_DEVICES='4' python reverie/main_nav_obj.py $flag  \
      --tokenizer bert \
      --resume_file dagger-clip768-seed.01000_wuxian_1000_0.5_0.7_gtk_rgspl_xin/ckpts/best_val_unseen \
      --test --submit